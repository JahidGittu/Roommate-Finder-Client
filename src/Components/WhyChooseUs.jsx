...
const WhyChooseUs = () => {
  ...
  return (
    <section className="py-12 px-4 md:px-8 ">
      <h2 className="text-3xl font-bold text-center text-gray-300 mb-10">Why Choose Us?</h2>
      <div className=" grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {features.map((feature) => (
          <div
            key={feature.id}
            className="hover:bg-gray-900 border border-gray-200 p-8 rounded-xl shadow hover:shadow-md text-center transition duration-300"
          >
