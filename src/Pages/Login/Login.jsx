    ...
    const handleSubmit = (e) => {
        ...
        loginUser(email, password)
            .then(result => {
                ...
                // navigate('/'); based on user navmenu click through location (pore korbo)
            })
            .catch(error => {
        ...
        <div className="flex items-center justify-center min-h-screen p-4 ">
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl shadow-md border border-gray-500">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button disabled={loading} className="block w-full p-3 text-center rounded-sm dark:text-gray-50 dark:bg-violet-600">
